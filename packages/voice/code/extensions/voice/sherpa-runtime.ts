...
import { defaultVoiceModelDir, readNazarSetupConfig } from "@nazar/core/setup";

const SHERPA_SETUP_HINT = "Run from this repository: cd packages/voice && npm install && node code/extensions/voice/setup-sherpa.mjs";
