...
export function registerSpotifyUse(pi: ExtensionAPI): void {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Before choosing music for a vague vibe request, use memory_search or read memory/pages/personal/music-preferences.md for durable music preferences, then choose a specific track unless the user asks for a playlist.",
